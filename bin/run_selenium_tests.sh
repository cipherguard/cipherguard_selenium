...
do
    case $opt in
        "Local PRO Version")
            isVariableSet CIPHERGUARD_BROWSER_EXTENSION_CHROME "Enter the path to the chrome browser extension:"
            isVariableSet CIPHERGUARD_BROWSER_EXTENSION_FIREFOX "Enter the path to the firefox browser extension:"
